...
public class ServerHandler {
	...
	public static float LightningDamageAmount = 20f;
	...
	public static float airOffDamageAmount = 20f;
	...
	public static float dragonBreathDamageAmount = 20f;
	...
	public static float CactusHurtsDamageAmount = 20f;
	...
	public static float FallingBlockDamageAmount = 20f;
	...
	public static float FoodOverhaulDamageAmount = 20f;
	...
	public static float LavaHurtsDamageAmount = 20f;
	
	// Wither Kills
	public static boolean witherDeath = false;
	public static float witherDeathDamageAmount = 20f;
	
	// Fire Hurts
	public static boolean inFire = false;
	public static float inFireDamageAmount = 20f;
	public static boolean onFire = false;
	public static float onFireDamageAmount = 20f;
	...
	public static float DmgDecrease = 1F;
